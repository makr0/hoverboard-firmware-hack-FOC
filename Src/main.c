  ...
  while(1) {
    ...
    calcAvgSpeed();                       // Calculate average measured speed: speedAvg, speedAvgAbs
      ...
      // ####### VARIANT_HOVERCAR ####### 
        ...
        #ifdef BRAKE_MORE
          // if we are driving forwards and the brake command is > 10
          // allow more current for braking
          if(speedAvg > 10 && cmd1 > 10) {
              rtP_Left.i_max = (I_MOT_MAX_BRAKE * A2BIT_CONV) << 4;        // fixdt(1,16,4)
